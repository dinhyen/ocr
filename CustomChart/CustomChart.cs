...
namespace CustomChart
{
	...
	/// 
	/// This is a copy of Kirillov's AForge.Chart class.  It is copied because
	/// there is no easy way to derive from the original class in order to add
	/// functionality.  The only component added is an overloaded version of 
	/// UpdateDataSeries.
	/// 
	/// </remarks>
	/// 
	public class CustomChart : System.Windows.Forms.Control
	{
		/// <summary>
		...
		/// <summary>
		/// Overloaded version of the original AddDataSeries.
		/// Update data series on the chart.
		/// </summary>
		/// 
		/// <param name="name">Data series name to update</param>
		/// <param name="data">Data series values</param>
		/// 
		public void UpdateDataSeries(string name, double[,] data, Color color)
		{
			// get data series
			DataSeries series = (DataSeries)seriesTable[name];
			// update data
